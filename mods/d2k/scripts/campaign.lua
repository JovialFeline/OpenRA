...
---@param pathFunction fun():cpos[] Returns a cpos[] for Carryall entry paths.
...
---@param customCondition? fun():boolean Returns if a condition has been met. If this function is absent, assume true.
...
---@param path cpos[]
---@param customCondition? fun():boolean
